# Contributing to Download Tools for ComfyUI

Thank you for your interest in contributing to Download Tools! This document provides guidelines and information for contributors.
...
```powershell
# Clone your fork
git clone https://github.com/YOUR_USERNAME/download_tools.git
cd download_tools
...
1. **Copy to ComfyUI custom_nodes:**
   ...
   # Example: mklink /D "C:\ComfyUI\custom_nodes\download_tools" "C:\path\to\your\download_tools"
   ```
...
print(f"[Yt-dlp] Downloaded {count} videos")
...
2. **Edge cases**: Empty inputs, invalid URLs, rate limits, authentication failures
...
- Use realistic test data (actual URLs, various websites, public profiles)
